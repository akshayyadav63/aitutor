...
// ⚠️ Store this key in an environment variable for security in production
...
${frustrationLevel >= 3 ? "- The student is frustrated. Provide slightly more guidance but still lead with questions. Acknowledge their effort.\n" : ""}
${frustrationLevel >= 4 ? "- The student is very frustrated. Offer partial answers or scaffolded hints, but end with a question that encourages engagement.\n" : ""}
${frustrationLevel >= 5 ? "- The student is extremely frustrated. Break down the problem, give substantial help, and if necessary, offer a direct solution. Still ask a follow-up question to re-engage their thinking.\n" : ""}
`;
    } else {
